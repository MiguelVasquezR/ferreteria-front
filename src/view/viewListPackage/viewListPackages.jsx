    ...
    <div>
      ...
      <div className="flex flex-col w-full max-w-[2000px] mx-auto">
        ...
        <div className="flex items-center mb-4">
          <h2 className="font-bold text-2xl ml-4">Paquetes</h2> {/* Agregado margen a la izquierda */}
        </div>

        {/* Renderizado del paquete */}
        <div className="w-full max-w-lg mx-auto"> {/* Aumentado el tamaño máximo */}
          {/* Contenedor del paquete con estilo */}
          <div className="card p-8 shadow-lg rounded-lg" style={{ fontFamily: 'Georgia', fontSize: '12px' }}>
            ...
            <div className="flex justify-between items-center mt-4">
              ...
              <div className="actions flex">
                <FaTrash style={{ color: 'orange', fontSize: '2rem' }} className="cursor-pointer" />
                <FaPen style={{ color: 'orange', fontSize: '2rem' }} className="ml-2 cursor-pointer" />
              </div>
              <p className="font-bold price text-lg">Precio: ${packageData.price}</p>
            </div>
          </div>
        </div>
      </div>
